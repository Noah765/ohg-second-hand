<section>
	...
	<p>
		...
		handeln, die Sie bei der Registrierung eingeben.
	</p>
	<p>
		Andere Daten werden automatisch beim Besuch der Website durch unsere IT-Systeme erfasst und für maximal einen Tag
		gespeichert. Das sind vor allem technische Daten (z.B. Internetbrowser, Betriebssystem oder Uhrzeit des
		Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website betreten.
	</p>
	<h4>Wofür nutzen wir Ihre Daten?</h4>
	<p>
		Ein Großteil der Daten wird benötigt, um andere Nutzer dieser Website eine sinnvolle Nutzung zu gewährleisten.
		Private Daten wie z.B. Ihre E-Mail-Adresse können zur Untersuchung und Eindämmung von betrügerischen oder illegalen
	...
	<h2>2. Hosting</h2>
	<p>
		Diese Website wird extern gehostet. Manche personenbezogenen Daten, die auf dieser Website erfasst werden, werden
		auf den Servern des Hosters für maximal eine Stunde gespeichert. Hierbei kann es sich v.a. um IP-Adressen, Meta- und
		Kommunikationsdaten, Websitezugriffe und Daten über den Internetbrowser sowie über des Betriebssystems handeln.
	</p>
	<p>
	...
	<p>
		Wir setzen Vercel Inc. als Hoster ein. Dieser Hoster befindet sich in San Francisco, Kalifornien, Vereinigte
		Staaten. Weitere Informationen finden Sie unter <a href="https://vercel.com">vercel.com</a>.
	</p>
	...
	<p>
		...
		Drittstaaten erfolgt die Datenverarbeitung außerdem auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO. Die Einwilligung
	...
	<p>
		Im Rahmen unserer Geschäftstätigkeit arbeiten wir mit verschiedenen externen Stellen zusammen. Dabei ist auch eine
		Übermittlung von personenbezogenen Daten an diese externen Stellen erforderlich. Wir geben personenbezogene Daten
	...
	<p>
		Wenn Sie die Verarbeitung Ihrer personenbezogenen Daten eingeschränkt haben, dürfen diese Daten &ndash; von ihrer
	...
	<p>
		...
		E-Mail-Adressen oder Passwörter, die Sie an uns als Seitenbetreiber senden, eine SSL- bzw. TLS-Verschlüsselung. Eine
	...
	<p>
		...
		Browser automatisch an uns übermittelt. Diese Daten werden für maximal einen Tag gespeichert. Dies sind:
	</p>
	<ul>
	...
	<h3>Angebotsdaten, Chatdaten, etc.</h3>
	<p>
		Bei der Benutzung dieser Seite werden unter anderem Angebots- und Chatdaten erhoben. Diese Daten werden in
		unterschiedlichen Eingabeformularen erfasst, an Verarbeitungsserver gesendet und letztendlich gespeichert. Wir
		arbeiten bei dieser Verarbeitung und Speicherung der Daten mit Supabase Inc. zusammen. Supabase Inc. befindet sich
		in San Francisco, Kalifornien, Vereinigte Staaten. Weitere Informationen über Supabase und den Aufenthalt Ihrer
		Daten finden Sie unter <a href="https://https://supabase.com">supabase.com</a>.
	</p>
	<p class="mt-20">
		Große Teile dieser Datenschutzerklärung wurden von <a href="https://www.e-recht24.de">e-recht24.de</a> generiert.
	</p>
</section>
